  ...
  return (
    <header className="rounded-xl border p-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-lg text-foreground">Professional panel</p>
        <button
          type="button"
          className="rounded-md border px-3 py-2 text-sm hover:bg-muted"
          onClick={() => setIsMenuOpen((open) => !open)}
          aria-expanded={isMenuOpen}
          aria-controls="professional-nav-drawer"
        >
          <svg
            className="fill-foreground h-6 w-6"
      ...
      >
        <div className="flex items-center justify-between border-b pb-3">
          <p className="text-sm font-semibold">Professional menu</p>
          <button
            type="button"
        ...
        <nav className="mt-4 flex flex-col gap-2">
          <Link
            href="/professional"
            className={linkClass(pathname, "/professional")}
            onClick={() => setIsMenuOpen(false)}
          >
            Overview
          </Link>
          <Link
            ...
            className={linkClass(pathname, "/professional/appointments")}
            onClick={() => setIsMenuOpen(false)}
          >
            Appointments
          </Link>
          <Link
            ...
            className={linkClass(pathname, "/professional/history")}
            onClick={() => setIsMenuOpen(false)}
          >
            History
          </Link>
