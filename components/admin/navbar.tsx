  ...
  return (
    <header className="rounded-xl border p-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-lg text-foreground">Admin panel</p>
        <button
          type="button"
      ...
      >
        ...
        <nav className="mt-4 flex flex-col gap-2">
          ...
          <Link
            ...
            className={linkClass(pathname, "/admin/users-management")}
            onClick={() => setIsMenuOpen(false)}
          >
            Users management
          </Link>
          <Link
            ...
            className={linkClass(pathname, "/admin/appointments-management")}
            onClick={() => setIsMenuOpen(false)}
          >
